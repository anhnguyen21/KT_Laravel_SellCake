        ...
        <form action="" method="post" class="beta-form-checkout">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                                    ...
                                    <a class="cart-item-delete" href="{{ route('xoagiohang',$product['item']['id']) }}"><i class="fa fa-times"></i></a>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="cart-item-amount"><input type="number" value="{{$totalQty}}"> <span>{{$product['item']['unit_price']}}</span></span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                    ...
                    <button class="text-center"><button type="submit"><a class="beta-btn primary">Đặt hàng <i class="fa fa-chevron-right"></i></a></button></div>
                    </div> <!-- .your-order -->
                </div>
            </div>
        </form>
