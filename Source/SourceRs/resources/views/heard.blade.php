        ...
        <div class="container">
            ...
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    ...
                    @if(Session::get('userName'))
                <li><a href="{{route('thoat')}}"><i class="fa fa-user"></i>Thoát</a></li>
            ...
            <div class="pull-right beta-components space-left ov">
                ...
                <div class="beta-comp">
                    <form role="search" method="post" id="searchform" action="{{route('search')}}">
                        @csrf
                        <input type="text" value="" name="sear" id="search" placeholder="Nhập từ khóa..." />
                ...
                <div class="beta-comp">
                    ...
                    @if(Session::has('cart'))
                    <div class="cart">
                        <div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (@if(Session::has('cart')){{ count(Session('cart')->items) }}@else Trong @endif) <i class="fa fa-chevron-down"></i></div>
                            ...
                            <a class="cart-item-delete" href="{{ route('xoagiohang',$product['item']['id']) }}"><i class="fa fa-times"></i></a>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="cart-item-amount">Số lượng: {{$product['qty']}} <span> giá sản phẩm:{{$product['price']}}</span></span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
